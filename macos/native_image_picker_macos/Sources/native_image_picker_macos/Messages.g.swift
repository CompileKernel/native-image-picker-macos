...
protocol ImagePickerApi {
  ...
  func openPhotosApp() throws -> Bool
}
...
class ImagePickerApiSetup {
  ...
  static func setUp(
    ...
    let supportsPHPickerChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.native_image_picker_macos.ImagePickerApi.supportsPHPicker\(channelSuffix)",
    ...
    let pickImagesChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.native_image_picker_macos.ImagePickerApi.pickImages\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pickVideosChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.native_image_picker_macos.ImagePickerApi.pickVideos\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pickMediaChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.native_image_picker_macos.ImagePickerApi.pickMedia\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns whether the Photos app was successfully opened.
    let openPhotosAppChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.native_image_picker_macos.ImagePickerApi.openPhotosApp\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      openPhotosAppChannel.setMessageHandler { _, reply in
        do {
          let result = try api.openPhotosApp()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      openPhotosAppChannel.setMessageHandler(nil)
    }
  }
}
